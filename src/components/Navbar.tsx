...
export default function Navbar() {
  ...
  const links = [
    ...
    return (
      <nav 
        className="fixed top-[14px] md:top-[20px] left-1/2 -translate-x-1/2 z-[100] w-[92%] md:w-[90%] max-w-[1120px] h-auto md:h-[72px] rounded-[24px] md:rounded-full flex flex-col md:flex-row justify-between items-center py-2 md:py-0 px-4 md:px-0 transition-all duration-300"
        style={{
      ...
      >
        ...
        <div className="w-full md:w-auto flex justify-between items-center md:h-full md:pl-[28px]">
          <Link href="/">
            <img 
              alt="BIGBRUVA Logo" 
              className="w-[48px] md:w-[68px] h-auto object-contain cursor-pointer" 
          ...
          <div className="flex md:hidden">
            <Link 
              href="/contact" 
              className="h-[32px] px-[12px] text-[#0A0A0A] font-bold rounded-full flex items-center justify-center gap-1.5 hover:brightness-105 active:scale-95 transition-all duration-300 text-[11px]"
              style={{
            ...
            >
              <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
