...
export default function Page() {
  ...
  return (
    <>
      ...
      {/* TopNavBar */}
      <header className={`fixed top-0 w-full z-50 transition-all duration-300 border-b border-soft-ivory/10 flex justify-between items-center px-margin-desktop py-base ${
        scrolled ? 'shadow-2xl bg-[#121413]/90 backdrop-blur-md' : 'bg-[#b2c5ff]/70 backdrop-blur-md dark:bg-[#b2c5ff]/70'
      }`}>
        <div className="flex items-center gap-4">
          <Link href="/" className="flex items-center gap-4 cursor-pointer">
            ...
            <span className="font-display-lg text-headline-md text-secondary tracking-widest uppercase animate-none">BIGBRUVA</span>
          </Link>
        </div>
        <nav className="hidden md:flex items-center gap-8">
          ...
          <Link className="text-secondary border-b-2 border-secondary pb-1 font-bold font-label-md" href="/events">Events</Link>
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex gap-4">
            <Link className="text-on-surface-variant hover:text-secondary font-label-md uppercase tracking-wider flex items-center" href="/community">Community</Link>
            <Link className="bg-secondary text-on-secondary px-6 py-2 font-label-md uppercase tracking-widest hover:bg-secondary-fixed transition-all" href="/contact">Contact</Link>
          </div>
        </div>
      </header>
