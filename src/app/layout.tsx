...
export const metadata: Metadata = {
  title: "EJTheVoice | Ejike Ibedilo Institutional Portal",
  description: "Broadcaster. Storyteller. Mentor. Voice of Generations. Recreating the institutional identity of Ejike Ibedilo.",
  icons: {
