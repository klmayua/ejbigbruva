...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const targetDivs = document.querySelectorAll('section > div');
    targetDivs.forEach(el => {
      (el as HTMLElement).style.opacity = '0';
      (el as HTMLElement).style.transform = 'translateY(20px)';
      (el as HTMLElement).style.transition = 'all 1s cubic-bezier(0.16, 1, 0.3, 1)';
      observer.observe(el);
    });
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .glass-panel {
            background: rgba(8, 46, 115, 0.15);
            backdrop-filter: blur(12px);
            border: 1px solid rgba(233, 195, 73, 0.1);
        }
        .timeline-line {
            background: linear-gradient(to bottom, transparent, #e9c349, transparent);
        }
        .gold-glow {
       ...
       <header className="relative min-h-[70vh] md:min-h-screen flex items-center justify-center overflow-hidden pt-16 md:pt-20">
        ...
        <div className="relative z-10 text-center px-margin-mobile md:px-margin-desktop">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <button className="border border-secondary/50 text-secondary px-10 py-4 font-label-md text-label-md rounded hover:bg-secondary/5 transition-all cursor-pointer">View Milestones</button>
          </div>
        </div>
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce opacity-50">
          <span className="material-symbols-outlined text-secondary text-3xl flex items-center justify-center">keyboard_double_arrow_down</span>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-8 group relative overflow-hidden glass-panel p-10 rounded shadow-2xl">
            <div className="flex justify-between items-start mb-12">
              ...
              <span className="font-display-lg text-headline-md text-on-surface/10 font-serif">2014</span>
            </div>
            ...
            <div className="flex items-center gap-4 text-secondary group-hover:gap-6 transition-all duration-300 cursor-pointer">
              ...
              <span className="material-symbols-outlined flex items-center">arrow_forward</span>
            </div>
          </div>
          {/* Bento Card 2 */}
          <div className="md:col-span-4 glass-panel p-10 rounded border-l-4 border-secondary flex flex-col justify-between">
            <div>
              <span className="material-symbols-outlined text-secondary text-4xl mb-8 flex" style={{ fontVariationSettings: "'FILL' 0" }}>workspace_premium</span>
          ...
          <div className="md:col-span-4 glass-panel p-10 rounded flex flex-col items-center text-center">
            <div className="w-16 h-16 rounded border border-secondary/20 flex items-center justify-center mb-8">
              <span className="material-symbols-outlined text-secondary text-3xl flex items-center">forum</span>
            </div>
          ...
          <div className="md:col-span-8 relative rounded overflow-hidden min-h-[400px] bg-primary-container/20 border border-white/5">
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-10">
              <span className="material-symbols-outlined text-secondary text-[240px] flex items-center justify-center" style={{ fontVariationSettings: "'FILL' 0" }}>inventory_2</span>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-32">
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div className="md:pl-16 order-1 md:order-2">
                  <div className="aspect-video glass-panel rounded flex items-center justify-center border border-white/5">
                    <span className="material-symbols-outlined text-secondary/20 text-6xl flex items-center" style={{ fontVariationSettings: "'FILL' 0" }}>podcasts</span>
                  </div>
                </div>
              </div>
              {/* Timeline Item 2 */}
              <div className="relative grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                <div className="md:pr-16 order-1">
                  <div className="aspect-video glass-panel rounded flex items-center justify-center border border-white/5">
                    <span className="material-symbols-outlined text-secondary/20 text-6xl flex items-center" style={{ fontVariationSettings: "'FILL' 0" }}>public</span>
                  </div>
                </div>
                <div className="absolute left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-secondary gold-glow z-20 hidden md:block"></div>
                <div className="md:pl-16 order-2">
                  <span className="font-display-lg text-headline-md text-secondary mb-2 block font-serif">2018</span>
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div className="md:pl-16 order-1 md:order-2">
                  <div className="aspect-video glass-panel rounded flex items-center justify-center border border-white/5">
                    <span className="material-symbols-outlined text-secondary/20 text-6xl flex items-center" style={{ fontVariationSettings: "'FILL' 0" }}>auto_awesome</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-32 px-margin-mobile md:px-margin-desktop text-center bg-surface">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <button className="border border-white/20 text-on-surface px-8 py-4 font-label-md text-label-md rounded flex items-center justify-center gap-3 hover:bg-white/5 transition-all cursor-pointer">
              <span className="material-symbols-outlined flex items-center" style={{ fontVariationSettings: "'FILL' 0" }}>mail</span>
              CONTACT ARCHIVIST
            </button>
          </div>
        </div>
