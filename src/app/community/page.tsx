...
<a className="text-on-surface-variant hover:text-secondary flex items-center gap-2 group" href="/">
...
<div className="w-full h-full bg-[url('https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&amp;w=2071&amp;auto=format&amp;fit=crop')] bg-cover bg-center" data-alt="A sophisticated black and white portrait of a senior mentor in a deep navy suit, guiding a young professional in a grand, dimly lit library with tall bookshelves and golden ambient lighting. The atmosphere is academic and elite, focusing on the passing of knowledge and prestige."></div>
</div>
...
<button className="mt-auto border border-secondary text-secondary py-3 font-label-md hover:bg-secondary/10 transition-colors uppercase">Read Impact Report</button>
</div>
</div>
</div>
</section>
...
<button className="bg-secondary text-on-secondary px-10 py-4 rounded-DEFAULT font-label-md hover:scale-105 transition-transform uppercase tracking-widest">Join the Community</button>
<button className="border border-secondary text-secondary px-10 py-4 rounded-DEFAULT font-label-md hover:bg-secondary/10 transition-colors uppercase tracking-widest">Support Us</button>
</div>
</div>
</section>
</main>
