...
<img alt="Reflective portrait for Voice editorial section" className="w-full h-full object-cover object-center opacity-60 scale-105 transition-transform duration-[10000ms] hover:scale-100" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDndsixHjhANHIuI883kfVDOBOzVqzWn_A9sdtc-aj_q1WzwtctGPBKKuAfxkQVDZSRLDEHXjYE3aHca4sQoGIMexkXZkAyieY7rWzBgrm43lAywRyonTh9lb1cGM4yKOje3hRGmkV8AQZqfY8D849XDxg4s37Ehfkkm1JocASoFnfUv06gUUjvw-VuAXDPtnO0H0Jv_lCXYwba1mKXdS2jcToqV2mo3WXJjkqaLbXaH08qIoe_ukGiqEAiLtqKfjpWJxRsgiCYL5k" />
</div>
...
<img className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" data-alt="A sophisticated close-up of an antique leather-bound journal resting on a dark mahogany desk. Soft ambient lighting catches the texture of the worn leather and the subtle glint of a fountain pen beside it. The background is a deep navy wall with a faint gold trim, creating a mood of quiet intellectual pursuit and historical preservation." src="https://lh3.googleusercontent.com/aida-public/AB6AXuAmI2UA1wMyhYSQ7c2Zv_MvCT9tDxjqs9_e7UEGbflaoQtgD6u19eVm6TwstQkdWXq4PSE_lNZ5jTwgjGBLKWiDtwxoNqhb7zkq3fJSWakSBKzK6uGKVAxEZ2eF1PiR7wiouaCLttXef-UiDfKpQ6bEqLq3fUVbHcf4MZZwt8yNbFWdFMuAVKZGYq_8PO84aN1qgppmUMaHYb1UXQlnFQLHrFn-hAJp4iVDz0sE-arLiwN28GVK4DvPNPPYDlSC-XXJUujMwHXcVCE" />
...
<img className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" data-alt="A collection of vintage black and white photographs spread across a dark table, illuminated by a single warm desk lamp. The lighting creates strong shadows and highlights the grainy texture of the old prints. The scene evokes a feeling of nostalgic investigation and the tangible weight of history, perfectly matching the premium navy and gold aesthetic." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDnnxJQ9vkkCiIUz9m9Ku8u4ehx0t0tMM0Y5rKlKZshVZWA8_DuEoANo4y0voB31y1uVl3NADGiNgxY3BuVFvf5LO1snOZoUemONqyi8xuBLsu3xGoifT-iOlwLf5QF_TWly-GJ5PqCiZInN8LdtWIJWclnd_YORyimKgJ95ctlK0IE92zZ9RHcYruqKgd8PilgtvRiMIBLq1aJ7J4npsj-5D6laosew2kgXNm43kYxth7Ua4qy7QkzXR9fgx7Pvtjbz_N88tmHPo0" />
...
<img className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" data-alt="High-contrast editorial shot of a bookshelf in a dark, luxury library. The spines of old books are barely illuminated by a sliver of golden light, revealing embossed titles in gold leaf. The deep navy blue of the surrounding shadows creates a sense of mystery, depth, and the infinite nature of knowledge and storytelling." src="https://lh3.googleusercontent.com/aida-public/AB6AXuB5H9BDG0nQBKU9vWf4Y5InSDlfwIJkKhrGHNHx3QYVtwJgQ9OzITVrGVfteNH5iI2rJOsbllAKGi3iUDW2pizOwYpdxv1aFtVpFLjePXNHPWOwkXRydKtof3eU7BKOM-tbN6uWml1M27WEFe1Zo9weV2WzUyjr00HHL0G59shONE3S-dpXMbNgOGUQeysLSEodIN-bx4o_tuFi9QHctUol2JIf8C8Fes_aAeGJKpZUWGAOPjZu2Z-pv_Ng171_zPMoxuXTSYrIlZQ" />
</div>
...
<div className="md:col-span-4 group cursor-pointer">
<div className="aspect-square overflow-hidden mb-6">
<img className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" data-alt="Minimalist abstract photograph featuring layers of deep navy blue textures intersecting with a sharp, thin line of glowing gold light. The composition is elegant and modern, representing the conceptual theme of 'Voice' and 'Identity' through light and shadow. The lighting is low-key, emphasizing a luxury editorial atmosphere suitable for a premium archive site." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBEX_iB19Uzhq1eG7ppPHl12UCnVfNbUOmQmNEKHMsrwJ1DYDsxABGyOPTnK8fOro7rRdB8af2b3qoO3fccH3hWYjDkr0CPNaMd-6OpVlu7miJIWMCk2f82dfp53QPziYOxlZKtB0Lc41GB-BUN6uRxMT61Oz_XRvh6KN5OXqjZuXHi65lhdqRGsjrIGVTBELGWqGapchlG5KOoEi4LRelnbKJSx7r-40myFlwstHSxVSJ7ifuzFjJOvdPk3kuRzqxydx40JO5a1ag" />
</div>
...
<div className="mb-12"><img alt="BIGBRUVA Official Crest" className="w-32 h-32 object-contain mx-auto mb-4 filter brightness-110" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCWvF-nHdw2xKstGjft8ySDVK94zelb6MpCkEiDtT3PB8YXAgFgSYTRjSILgn5BvsGjb8lQmrgvgruVQDyp5-wOa5NCgbujblFQ_9CiIGu8T-eLVUcjr-FzmkhptVpclIV49zl-7XM7EQFTibf-k2lRoNuCBdPeNi1GNgvX4B7FUwB40bOJud9sWs-2TOB6nXSBiJLWIxGhYfQVUOlsC9jjYDuDknGT_-IGmQMPwL4oGy-3cSjdPWDsU2Cha_B7DU9NEB_kmzHoZSs" /><h2 className="font-display-lg text-headline-lg text-secondary opacity-40 text-center uppercase tracking-[0.2em]">BIGBRUVA</h2></div>
<div className="flex flex-wrap justify-center gap-8 mb-12"><img alt="BIGBRUVA Official Crest" className="w-32 h-32 object-contain mx-auto mb-4 filter brightness-110" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCWvF-nHdw2xKstGjft8ySDVK94zelb6MpCkEiDtT3PB8YXAgFgSYTRjSILgn5BvsGjb8lQmrgvgruVQDyp5-wOa5NCgbujblFQ_9CiIGu8T-eLVUcjr-FzmkhptVpclIV49zl-7XM7EQFTibf-k2lRoNuCBdPeNi1GNgvX4B7FUwB40bOJud9sWs-2TOB6nXSBiJLWIxGhYfQVUOlsC9jjYDuDknGT_-IGmQMPwL4oGy-3cSjdPWDsU2Cha_B7DU9NEB_kmzHoZSs" /><h2 className="font-display-lg text-headline-lg text-secondary opacity-40 text-center uppercase tracking-[0.2em]">BIGBRUVA</h2></div>
