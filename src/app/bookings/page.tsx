...
<select className="w-full bg-primary-container/20 border-0 border-b-2 border-on-surface/20 text-on-surface focus:border-secondary focus:ring-0 transition-all py-3">
<option>Keynote Speaking</option>
<option>Panel Moderation</option>
<option>Brand Ambassadorship</option>
<option>Voiceover Commission</option>
...
<button className="w-full py-5 bg-secondary text-on-secondary font-display-lg text-headline-md hover:brightness-110 transition-all active:scale-95 shadow-xl" type="submit">
                        Submit Inquiry
                    </button>
</form>
</div>
